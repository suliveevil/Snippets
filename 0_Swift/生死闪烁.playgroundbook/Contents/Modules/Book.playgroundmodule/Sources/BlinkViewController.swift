...
public class BlinkViewController: UIViewController, PlaygroundLiveViewSafeAreaContainer {
    ...
    override public func viewDidLoad() {
        ...
        // Accessibility (QE Automation)
        stepButton.addAccessibility(name: "Step")
        resetButton.addAccessibility(name: "Reset")
        playPauseButton.addAccessibility(name: "Pause")
    ...
    func pauseSimulation() {
        ...
        playPauseButton.addAccessibility(name: "Resume")
    }
...
// MARK: Accessibility
extension UIButton {
    func addAccessibility(name: String) {
        self.accessibilityIdentifier = "\(type(of: self)).\(name)"
    }
}
