...
public class GameViewController: UIViewController {
    ...
    private enum Defaults {
        ...
        static let tieText = NSLocalizedString("TIE", comment: "a game with equal score")
        
        static let winText = NSLocalizedString("YOU WIN", comment: "you win the game")
        
        static let loseText = NSLocalizedString("YOU LOSE", comment: "you lost the game")

        static let goActionText = NSLocalizedString("GO!", comment: "start the game")
        
        static let nextRoundActionText = NSLocalizedString("Next Round", comment: "play another turn in the game")
        
        static let newGameActionText = NSLocalizedString("New Game", comment: "Start a new game")
        
        static let tryAgainActionText = NSLocalizedString("Try Again", comment: "play the game again")
        
        static let noActionsDefinedMessage = NSLocalizedString("You need to define at least one action to play the game.", comment:"feedback to the user if incorrect code")
        
        static let noOpponentDefinedMessage = NSLocalizedString("You need to define at least one opponent to play the game.", comment:"feedback to the user if incorrect code")
        
        static let tooManyOpponentsMessage = NSLocalizedString("You can have no more than four opponents for the game.", comment:"feedback to the user if incorrect code")
    }
    ...
    private func setupViews() {
        ...
        layoutGuideHeightConstraint.priority = UILayoutPriority(rawValue: 999)
        ...
        layoutGuideWidthConstraint.priority = UILayoutPriority(rawValue: 999)
        ...
        mainActionViewMinTopAnchor.priority = UILayoutPriority(rawValue: 800)
        ...
        mainActionViewHeightConstraint.priority = UILayoutPriority(rawValue: 901)
        ...
        buttonSizeConstraint.priority = UILayoutPriority(rawValue: 999)
    ...
    private func setupBotPlayers() {
        ...
        for (index, player) in game.opponents.enumerated() {
            ...
            if index == 0 {
                ...
                botWidthConstraint.priority = UILayoutPriority(rawValue: 800)
                ...
                botMaxWidthConstraint.priority = UILayoutPriority(rawValue: 801)
                ...
                botMaxViewWidthConstraint.priority = UILayoutPriority(rawValue: 802)
                ...
                spacerReadyWidthConstraint.priority = UILayoutPriority(rawValue: 700)
            ...
            readyPositionConstraint.priority = UILayoutPriority(rawValue: 700)
            ...
            leadingConstraint.priority = UILayoutPriority(rawValue: 700)
    ...
    private func updateLabels() {
        ...
        let newFont = UIFont.systemFont(ofSize: fontSize, weight: UIFont.Weight(rawValue: 5))
