...
class PlayerViewController: UIViewController, CAAnimationDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        func path(withRadius radius: CGFloat) -> CGPath {
            ...
            return UIBezierPath(arcCenter:centerPoint, radius: radius, startAngle: .pi / -2.0, endAngle: (.pi / 2.0) * 3.0, clockwise: true).cgPath
        }
    ...
    func gameEnded() {
        ...
        winnerTimer = Timer.scheduledTimer(withTimeInterval: Defaults.prizeTimerInterval, repeats: false) { _ in
            ...
            prizeLabel.font = UIFont.systemFont(ofSize: 300, weight: UIFont.Weight(rawValue: 5))
